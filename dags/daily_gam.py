...
def get_gam_api_data(**context):
    ...
    report_file = f'/opt/airflow/dags/bg_gam_{today}_daily.csv'
    ...
    gam_df.to_gbq(destination_table='gam.gam-daily', project_id='gcp-bg', if_exists='append', credentials=creds, table_schema=[
      {'name': 'DATE', 'type': 'DATE'},
